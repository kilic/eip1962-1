pub struct CELO1157Executor;

// use crate::engines::bls12_377::{self, mapping};
...
mod test {
    ...
    fn test_g1_add() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/g1_add.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g1_add(&encoding).unwrap();
    ...
    fn test_g1_point_mul() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/g1_mul.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g1_mul(&encoding).unwrap();
    ...
    fn test_g1_multiexp() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/g1_multiexp.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g1_multiexp(&encoding).unwrap();
    ...
    fn test_g2_add() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/g2_add.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g2_add(&encoding).unwrap();
    ...
    fn test_g2_point_mul() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/g2_mul.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g2_mul(&encoding).unwrap();
    ...
    fn test_g2_multiexp() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/g2_multiexp.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g2_multiexp(&encoding).unwrap();
    ...
    fn generate_pairing_vectors() {
        ...
        let mut writer = make_csv_writer("src/test/test_vectors/celo1157/pairing.csv");
    ...
    fn generate_negative_test_pairing_invalid_subgroup() {
        ...
        let mut writer = make_csv_writer(
            "src/test/test_vectors/celo1157/negative/invalid_subgroup_for_pairing.csv",
        );
        assert!(writer.is_some());
        ...
        for j in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::pair(&input);
    ...
    fn test_not_on_curve_g1() {
        ...
        let mut writer =
            make_csv_writer("src/test/test_vectors/celo1157/negative/g1_not_on_curve.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g1_mul(&encoding)
                .err()
                .unwrap()
                .to_string();
    ...
    fn test_not_on_curve_g2() {
        ...
        let mut writer =
            make_csv_writer("src/test/test_vectors/celo1157/negative/g2_not_on_curve.csv");
        ...
        for _ in 0..NUM_TESTS {
            ...
            let api_result = CELO1157Executor::g2_mul(&encoding)
                .err()
                .unwrap()
                .to_string();
    ...
    fn generate_invalid_fp_encoding_vectors() {
        ...
        let mut writer =
            make_csv_writer("src/test/test_vectors/celo1157/negative/invalid_fp_encoding.csv");
        assert!(writer.is_some());
        let modulus = BigUint::from_str_radix("258664426012969094010652733694893533536393512754914660539884262666720468348340822774968888139573360124440321458177", 10).unwrap();
        ...
        for j in 0..NUM_TESTS {
            ...
            // let api_result = CELO1157Executor::map_fp_to_g1(&input)
            //     .err()
            //     .unwrap()
            //     .to_string();

            let api_result: String = String::from("is not an element of the field");
    ...
    fn generate_invalid_fp2_encoding_vectors() {
        ...
        let mut writer =
            make_csv_writer("src/test/test_vectors/celo1157/negative/invalid_fp2_encoding.csv");
        assert!(writer.is_some());
        let modulus = BigUint::from_str_radix("258664426012969094010652733694893533536393512754914660539884262666720468348340822774968888139573360124440321458177", 10).unwrap();
        ...
        for j in 0..NUM_TESTS {
            ...
            // let api_result = CELO1157Executor::map_fp2_to_g2(&input)
            //     .err()
            //     .unwrap()
            //     .to_string();
            let api_result: String = String::from("is not an element of the field");
    ...
    fn dump_vectors_into_fuzzing_corpus() {
        ...
        for (b, f) in byte_idx.into_iter().zip(file_paths.into_iter()) {
            let mut reader =
                csv::Reader::from_path(&format!("src/test/test_vectors/celo1157/{}", f)).unwrap();
            for r in reader.records() {
                ...
                std::fs::write(
                    &format!("src/test/test_vectors/celo1157/fuzzing/{}", name),
                    &output,
                )
                .unwrap();
    ...
    fn run_g1_add_on_vector() {
        let p = "src/test/test_vectors/celo1157/g1_add.csv";

        let f = |input: &[u8]| CELO1157Executor::g1_add(input).map(|r| r.to_vec());
    ...
    fn test_external_g2_multiexp_vectors() {
        let p = "src/test/test_vectors/celo1157/extras/g2_multiexp.csv";

        let f = |input: &[u8]| CELO1157Executor::g2_multiexp(input).map(|r| r.to_vec());
    ...
    fn dump_extra_vectors_into_fuzzing_corpus() {
        let byte_idx: Vec<u8> = vec![1, 2, 3, 4, 5, 6, 7, 8, 9];
        let file_paths = vec!["g2_multiexp.csv"];

        let mut counter = 0;

        for (b, f) in byte_idx.into_iter().zip(file_paths.into_iter()) {
            let mut reader =
                csv::Reader::from_path(&format!("src/test/test_vectors/celo1157/extras/{}", f))
                    .unwrap();
            for r in reader.records() {
                let r = r.unwrap();
                let input = hex::decode(r.get(0).unwrap()).unwrap();
